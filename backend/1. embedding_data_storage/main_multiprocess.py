            ...
            with tqdm(total=total_docs) as pbar, mp.Manager() as manager:
                ...
                while hits:
                    try:
                        ...
                        # * IMP: Changes made to convert from Sequential to MultiProcessing
    ...
    for doc in tqdm(data):
        ...
        if doc["_source"].get("keywords") is not None:
            doc["_source"]["keywords"] = (
                ...
                else list({term["name"].lower() for term in doc["_source"]["keywords"]})
            )
        else:
        ...
        for j, chunk in enumerate(chunks):
            ...
            metadata = {
                ...
                "journalTitle": doc["_source"]["journalInformation"]["journalTitle"],
